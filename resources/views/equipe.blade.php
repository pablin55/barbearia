...
<div class="top-header position-relative">
    <div class="language-dropdown">
        ...
        <div class="lang-menu" id="langMenu">
            <div onclick="setLanguage('pt')">
                <img src="https://flagcdn.com/w20/br.png"> Português
            </div>
            <div onclick="setLanguage('en')">
                <img src="https://flagcdn.com/w20/us.png"> English
            </div>
            <div onclick="setLanguage('es')">
                <img src="https://flagcdn.com/w20/es.png"> Español
            </div>
        </div>
    </div>
    ...
    <div class="row align-items-center py-3 px-xl-5 m-0">
        <div class="col-lg-3 d-none d-lg-block">
            <img src="{{ asset('img/pbar.png') }}" style="height: 120px;">
        </div>
...
<section class="team-section hidden">
    <div class="container">
        ...
        <h1 class="team-title hidden" data-i18n="team-title">
